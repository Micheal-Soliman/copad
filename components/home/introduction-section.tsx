...
export function IntroductionSection({
  ...
  return (
    <section className="overflow-hidden px-4 py-14 sm:px-8 sm:pt-16 sm:pb-10 lg:px-12 lg:pt-16 lg:pb-12">
      <div dir="ltr" className="mx-auto grid max-w-[1440px] items-center gap-10 sm:gap-16 lg:grid-cols-[1.08fr_.92fr] lg:gap-24">
        <motion.div
        ...
        >
          ...
          <motion.div
            ...
            whileTap={reduceMotion ? undefined : { scale: 0.985, y: -4 }}
        ...
        >
          ...
          <h2 className="mt-5 max-w-3xl font-display text-4xl leading-[1.02] tracking-[-0.04em] text-copad-deep sm:text-5xl lg:text-7xl">{title}</h2>
