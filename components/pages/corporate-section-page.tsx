          ...
          {content.blocks.map((block, index) => (
            <Reveal key={block.title} delay={Math.min(index * 60, 240)}>
              <article
                className={
                  layout === "cards"
                    ? "h-full rounded-[1.5rem] border border-copad-deep/10 bg-white p-5 shadow-[0_16px_45px_rgba(6,79,120,.06)] transition duration-500 hover:-translate-y-1 hover:shadow-[0_22px_55px_rgba(6,79,120,.11)] sm:rounded-[1.75rem] sm:p-7 lg:p-9"
