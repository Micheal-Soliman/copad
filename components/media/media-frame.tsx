...
export function MediaFrame({ label, src, priority = false, placeholderLabel = "" }: MediaFrameProps) {
  return (
    <figure className="group relative aspect-[4/3] min-h-0 overflow-hidden rounded-[1.5rem] bg-copad-deep shadow-[0_20px_50px_rgba(6,79,120,.16)] sm:aspect-[4/5] sm:min-h-[420px] sm:rounded-[2rem] sm:shadow-[0_26px_70px_rgba(6,79,120,.18)]">
      {src ? (
        <Image
