  ...
  return (
    <section ref={sectionRef} id="home" style={homeScrollSceneStyle(4)} className="relative min-h-svh bg-copad-deep text-white lg:h-[var(--scroll-scene-height)]">
      <div className="relative isolate min-h-[100svh] overflow-hidden lg:sticky lg:top-0 lg:h-screen">
        <div aria-hidden="true" className="absolute inset-0 -z-20 bg-[radial-gradient(circle_at_70%_42%,rgba(0,172,208,.4),transparent_34%),radial-gradient(circle_at_16%_88%,rgba(255,255,255,.12),transparent_26%),linear-gradient(135deg,#075b85,#075b85_55%,#096a96)]" />
  ...
  return (
    ...
    >
      <div className="absolute inset-0 [perspective:1600px]">
        <motion.div className="absolute inset-0 overflow-hidden border border-copad-green/65 bg-[#075b85] shadow-[0_45px_110px_rgba(0,0,0,.38),0_0_75px_rgba(0,172,208,.22)] [transform-style:preserve-3d]" style={{ scale, rotateY }}>
